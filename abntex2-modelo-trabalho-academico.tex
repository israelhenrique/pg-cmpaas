...
A utilização do plugin é bem simples. Ao acessar uma tarefa o estudante deve clicar no botão de envio de tarefa e ao fazer isto o editor de mapas ira ser mostrado na tela, como na . Após criar ou editar o mapa o aluno deve clicar no botão “Salvar alterações” e o json será salvo no banco de dados da plataforma e aparecerá no sumário, confome \autoref{fig_editor}. Ao clicar no botão Sincronizar Mapa o diagrama será sincronizado na Nuvem da plataforma CMPaaS.

\begin{figure}[htb]
	\caption{\label{fig_editor} Sumário da tarefa}
	\begin{center}
...
Nesta seção será apresentada a utilização de todas as funcionalidades oferecidas pelo plugin.
