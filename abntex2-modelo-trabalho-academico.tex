...
% ---
\section{A definição de mapas conceituais}
% ---
Os mapas conceituais são uma ferramenta gráfica utilizada para representação do conhecimento, esta representação é constituida por relações entre conceitos na forma de proposições. Cada proposição é formada por dois ou mais conceitos interligados por uma palavra, que descreve a relação entre os conceitos. A \autoref{fig_mapconceitual} mostra um exemplo de mapa conceitual.
...
O mapas conceituais foram criados na década de 70 durante um estudo de Novak que buscava entender como crianças aprendiam conceitos científicos \cite{Novak2005}. Durante seu estudo, Novak observou uma evolução nas proposições utilizadas pelas crianças, porém teve dificuldade de entender como esta mudança congnitiva ocorreu. Para compreender as mudanças na estruturas cognitivas observadas no estudo a equipe de pesquisa de Novak se baseou nas três ideias de Ausubel sobre a teoria da aprendizagem \cite{ausubel1963}.
\begin{citacao}[english]
	First, Ausubel sees the development
	of new meanings as building on prior relevant concepts and propositions. Second,
	he sees cognitive structure as organised hierarchically, with more general, more in-
	clusive concepts occupying higher levels in the hierarchy and more specific, less
	inclusive concepts subsumed under the more general concepts. Third, when mean-
	ingful learning occurs, relationships between concepts become more explicit, more
	precise, and better integrated with other concepts and propositions\cite{Novak2005}.
\end{citacao}
Assim foi criada a ferramenta gráfica mapas conceituais, que consiste em conceitos interligados por uma palavra descritiva, formando proposições, e organizada de forma hierárquica, onde os conceitos mais gerais estão dispostos no topo do mapa e os mais específicos na parte inferior dele.
\section{Mapas conceituais e educação}
A confiabilidade da avaliação da aprendizagem tradicional,como textos dissertativos e questões de multipla escolha, tem sido questionada por pesquisadores e educadores. Nestes tipos de teste apenas os acertos são contabilizados e os erros são descartados, isto pode fazer com que informações importantes para a avaliação sejam deprezadas.
