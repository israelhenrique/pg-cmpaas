...
% ---
\section{A história e definição de mapas conceituais}
% ---
...
Assim foi criada a ferramenta gráfica mapas conceituais, que tem como objetivo fazer uma representação do conhecimento. Um mapa conceitual é constituido por interligações de conceitos, formando proposições. Uma proposição consiste na ligação entre dois ou mais conceitos através de uma palavra de forma a gerar um significado. Em um mapa conceitual os conceitos mais gerais estão dispostos no topo do mapa e os mais específicos na parte inferior dele. Um mapa conceitual é construido ligando-se um conceito a outro, através de um arco que contém uma palavra descritiva, que é usada para criar uma relação significativa entre os conceitos. A \autoref{fig_mapconceitual} mostra um exemplo de mapa conceitual.
