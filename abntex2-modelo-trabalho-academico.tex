...
A construção de mapas conceituais com papel e caneta é muito simples, porém a tarefa de revisa-lo pode ser muito cansativa e consumir muito tempo. A introdução do uso de computadores na confecção de mapas pode facilitar a tarefa. Porém os primeiros programas de computadores criados com este objetivo se limitavam a mostrar os mapas na tela, sem oferecer nenhum recurso adicional a ferramenta. O software CmapTools alterou esta realidade, ao trazer a Internet para o contexto de criação de mapas conceituais.\cite{Novak2006}.
