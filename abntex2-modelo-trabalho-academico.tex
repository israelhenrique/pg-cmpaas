...
\begin{resumo}
 Este trabalho apresenta a concepção e o desenvolvimento de um \textit{plugin} de edição de mapas conceituais em cursos gerenciados pelo Moodle com integração à uma plataforma de serviços de mapas conceituais, o CMPaaS. Aborda a importância do Moodle na Educação a Distância e detalha os processos e tecnologias utilizadas na construção de um plugin para ele. Discute também como é possível integrar o Moodle com outras plataformas de serviços.
...
claro, de ser amplamente utilizada por instituições de ensino no mundo todo. Avaliando a lista de plugins do Moodle, foi constatado que não há nenhuma ferramenta que permita
...
Devido ao Moodle ser muito utilizado, um plugin de elaboração de mapas conceituais implementado nele poderia gerar uma grande quantidade de conteúdo, que  os serviços da plataforma CMPaaS poderiam utilizar, por exemplo, o serviço de geração de inferências. Por esse motivo o plugin desenvolvido nesse trabalho também será integrado ao CMPaaS.
...
O produto final deste trabalho será um plugin que disponibiliza um editor de criação de mapas conceituais em cursos da plataforma Moodle. O plugin utilizará a plataforma CMPaaS como solução de armazenamento dos mapas conceituais na nuvem.
