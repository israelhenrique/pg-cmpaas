...
**Descrever uma troca de mensagens e cabeçalhos. Colocar figuras.**

Os cabeçalhos de resposta possuem códigos que servem para identificar se uma requisição foi concluida com sucesso. Por exemplo,um código de resposta 200 indica que uma requisição foi concluida com sucesso, já um código 401 indica que URI acessada exige autenticação do usuário.
...
**Como explicar os métodos?**

Métodos HTTP:
GET - Requitar informações sobre um recurso,
POST - Criar um novo recurso, processamento de informações 
DELETE - Remover um recurso,
PUT - Atualziar um novo recurso, ou criar um novo, 
HEAD - Retornar informações sobre um recurso, sem body
OPTIONS
TRACE
CONNECT
