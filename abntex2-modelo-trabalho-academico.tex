...
\begin{figure}[htb]
	...
	\begin{center}
		\includegraphics[scale=0.4]{seqcriar.png}
	\end{center}
	\legend{Fonte: Elaborado pelo autor}
\end{figure}
...
\begin{figure}[htb]
	...
	\begin{center}
		\includegraphics[scale=0.4]{seqeditar.png}
	\end{center}
	\legend{Fonte: Elaborado pelo autor}
\end{figure}
...
A outra forma é a apagar todas as versões de um mapa, eliminando todo o histórico do mapa do repositório. A sequencia de eventos desta funcionalidade é mostrada na \autoref{fig_apagarmap}.  

\begin{figure}[htb]
	\caption{\label{fig_apagarver} Apagar versão}
	\begin{center}
		\includegraphics[scale=0.4]{apagarver.png}
	\end{center}
	\legend{Fonte: Elaborado pelo autor}
\end{figure}
...
\begin{figure}[htb]
	...
	\begin{center}
		\includegraphics[scale=0.4]{apagarmap.png}
	\end{center}
	\legend{Fonte: Elaborado pelo autor}
\end{figure}
